...
export default function App() {
  ...
  return (
    ...
    >
      ...
      <div style={{ position:"absolute", top:10, right:10, display:"flex", gap:"10px", zIndex:2, flexWrap:"wrap" }}>
        ...
        <a href="https://docs.google.com/document/d/1y8SCFvIc41yUzB25gZpygUmxQex8ZT0dk8sKQ4Hl2T8/edit?usp=sharing" target="_blank" rel="noopener noreferrer">
          Instructions
        </a>
      </div>
